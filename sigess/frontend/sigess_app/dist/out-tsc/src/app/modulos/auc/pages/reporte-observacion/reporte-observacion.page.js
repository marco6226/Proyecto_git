...
var ReporteObservacionPage = /** @class */ (function () {
    function ReporteObservacionPage(offlineService, modalController, router) {
    ...
    ReporteObservacionPage.prototype.ngOnInit = function () {
        var _this = this;
        this.offlineService.queryTarjetaObservacion().then(function (data) { return _this.tarjetaList = data; });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.modalController.create({
                            component: observacion_form_component_1.ObservacionFormComponent,
...
exports.ReporteObservacionPage = ReporteObservacionPage;
//# sourceMappingURL=reporte-observacion.page.js.map