...
import { EventEmitter, ChangeDetectorRef, NgZone, ViewChild, ElementRef, Input, HostBinding, Output, HostListener, Component, ChangeDetectionStrategy, NgModule } from '@angular/core';
...
__decorate([
    ViewChild('sourceImage', { static: true }),
